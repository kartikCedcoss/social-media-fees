...
<nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
    <div class="container">
    <a class="navbar-brand" href="#">ROCKERS group</a>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form"  action="functions.php" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="phone_number" class="form-control" name="mob" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="permanent_address" class="form-control" name="country">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="nid_number" class="col-md-4 col-form-label text-md-right">
                                             Pincode</label>
                                    <div class="col-md-6">
                                        <input type="text" id="nid_number" class="form-control" name="pincode">
                                    </div>
                                </div>

                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-primary" name="btnreg">
                                        Register
                                        </button>
                                    </div>
                                </div>
